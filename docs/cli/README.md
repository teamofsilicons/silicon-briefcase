...
IAM in production. In testing, supply the Carbon or Silicon ID as SLT instead. Production returns null for both environment IDs. No app secret or
...
commands with `--test`. In testing the SLT is the existing Carbon or Silicon ID
