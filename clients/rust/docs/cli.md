...
The canonical guide now lives in the backend repository:
...
Run `briefcase --help` or `briefcase <command> --help` for the installed version's
syntax. This compatibility page avoids keeping a stale second integration guide.
